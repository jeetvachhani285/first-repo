                ...
                if drawColor == (0, 0, 0):
                    ...
                    if shape == 'triangle' and (cTime-pTime).total_seconds()>1:
                        ...
                        if fingers[4]:
                            pTime=cTime
                            if drawFilled:
                                cv2.line(imgCanvas,(f1,f2),(z1-50,z2),color=drawColor,thickness=brushThickness)
                                cv2.line(imgCanvas,(f1,f2),(z1+50,z2),color=drawColor,thickness=brushThickness)
                                cv2.line(imgCanvas,(z1-50,z2),(z1+50,z2),color=drawColor,thickness=brushThickness)
                            else:
                                cv2.line(imgCanvas,(f1,f2),(z1-50,z2),color=drawColor,thickness=brushThickness)
                                cv2.line(imgCanvas,(f1,f2),(z1+50,z2),color=drawColor,thickness=brushThickness)
                                cv2.line(imgCanvas,(z1-50,z2),(z1+50,z2),color=drawColor,thickness=brushThickness)
